...
FROM '/home/dschuster/Desktop/daily/SQL_I/SQL_I/student_data.csv'
DELIMITER ',' CSV HEADER;

COPY term_gpa(id,term,gpa)
FROM '/home/dschuster/Desktop/daily/SQL_I/SQL_I/term_gpa_data.csv'
DELIMITER ',' CSV HEADER;

COPY degrees(id,term,degree)
FROM '/home/dschuster/Desktop/daily/SQL_I/SQL_I/degrees_data.csv'
DELIMITER ',' CSV HEADER;
